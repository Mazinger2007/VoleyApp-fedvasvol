...
import {
  ...
  Platform, useWindowDimensions, Modal, Animated
} from 'react-native';
...
import { ensureLogoColorsCached } from '../../utils/logoColorCache';
import { Radius, Spacing, Typography } from '../../styles/theme';
import { useTheme } from '../../contexts/ThemeContext';
import { useFavorites } from '../../contexts/FavoritesContext';
import StatusModal from '../../components/StatusModal';
import { cacheTeamsFromRanking } from '../../utils/teamCache';
...
export default function LeagueDetailScreen({ route, navigation }) {
  ...
  useLivePolling(fetchCalendarUrl, calendarBlocksRaw, setLiveCalendarBlocks, refreshRanking);
  ...
  useEffect(() => {
    ...
    if (logos.length) ensureLogoColorsCached(logos, getDominantColor);
  }, [rankingBlocks]);
  ...
  }, [navigation, activeCalendarUrl, rankingBlocks, calendarBlocks]);
      ...
      {isGlobalLoading ? (
        ...
        <>
          ...
          <View style={styles.tabBar}>
            ...
            <Animated.View style={[styles.tabIndicator, { width: tabWidth, transform: [{ translateX: tabIndicatorTranslateX }] }]} />
          </View>
